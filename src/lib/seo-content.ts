// ============================================================
// OCÉAN DU NORD — Contenu SEO (source unique de vérité)
// Partagé entre :
...
export const SEO_TEXT = {
  ...
  title: "Billets de bus interurbains au Congo | Océan du Nord",
  ...
  ogImageAlt:
    "Bus interurbain Océan du Nord sur la route entre Brazzaville et Pointe-Noire",
...
export const FAQ_ITEMS: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Mobile Money (MTN MoMo et Airtel Money, selon activation), espèces au guichet des agences Océan du Nord, carte bancaire et virement bancaire.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Oui, tant que le paiement n'est pas confirmé : une réservation en attente de paiement peut être annulée depuis le suivi de billet ou auprès d'un agent Océan du Nord.",
  },
  {
    question: "Comment se passe l'embarquement ?",
    answer:
      "Présentez le QR code de votre billet électronique au contrôleur Océan du Nord au départ. Chaque billet est unique et vérifié à l'embarquement.",
  },
];
