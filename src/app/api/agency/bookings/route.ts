// GET /api/agency/bookings?page&status&q — réservations du scope agence (paginé 10/page)
// Filtre q : référence, nom du passager, téléphone.
...
export async function GET(req: NextRequest) {
  try {
    ...
    const { page, pageSize } = parsePagination(req.nextUrl, 10);
    ...
    return routeError(err, "GET /api/agency/bookings");
  }
}
