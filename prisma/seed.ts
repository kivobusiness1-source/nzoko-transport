...
async function main(): Promise<void> {
  ...
  const teamUsers = [
    { email: "kivobusiness1+superadmin@gmail.com", password: "Nzoko@2026!", firstName: "Aimé", lastName: "Directeur", role: "SUPER_ADMIN", agencyId: null, phone: "242061000000" },
    { email: "kivobusiness1+admin@gmail.com", password: "Admin@2026!", firstName: "Clarisse", lastName: "Opérée", role: "ADMIN", agencyId: null, phone: "242061000001" },
    { email: "kivobusiness1+manager@gmail.com", password: "Manager@2026!", firstName: "Hervé", lastName: "Responsable", role: "AGENCY_MANAGER", agencyId: agencyPN.id, phone: "242061000002" },
    { email: "kivobusiness1+agent@gmail.com", password: "Agent@2026!", firstName: "Bénédicte", lastName: "Guichet", role: "AGENT", agencyId: agencyPN.id, phone: "242061000003" },
    { email: "kivobusiness1+checker@gmail.com", password: "Checker@2026!", firstName: "Wilfried", lastName: "Contrôleur", role: "CHECKER", agencyId: agencyPN.id, phone: "242061000004" },
    { email: "kivobusiness1+comptable@gmail.com", password: "Compta@2026!", firstName: "Flore", lastName: "Comptable", role: "ACCOUNTANT", agencyId: null, phone: "242061000005" },
    { email: "kivobusiness1+chauffeur@gmail.com", password: "Chauffeur@2026!", firstName: "Jean-Félix", lastName: "Mabiala", role: "DRIVER", agencyId: agencyPN.id, phone: "242061000006" },
    { email: "kivobusiness1+support@gmail.com", password: "Support@2026!", firstName: "Léa", lastName: "Assistance", role: "SUPPORT", agencyId: null, phone: "242061000007" },
  ];
  ...
  console.log("  kivobusiness1+superadmin@gmail.com     / Nzoko@2026!   (SUPER_ADMIN)");
  console.log("  kivobusiness1+admin@gmail.com          / Admin@2026!    (ADMIN)");
  console.log("  kivobusiness1+manager@gmail.com     / Manager@2026!  (AGENCY_MANAGER — Pointe-Noire)");
  console.log("  kivobusiness1+agent@gmail.com       / Agent@2026!    (AGENT — Pointe-Noire)");
  console.log("  kivobusiness1+checker@gmail.com     / Checker@2026!  (CHECKER — Pointe-Noire)");
  console.log("  kivobusiness1+comptable@gmail.com      / Compta@2026!   (ACCOUNTANT)");
  console.log("  kivobusiness1+chauffeur@gmail.com / Chauffeur@2026! (DRIVER)");
  console.log("  kivobusiness1+support@gmail.com        / Support@2026!  (SUPPORT)");
  console.log("──────────────────────────────────────────────────");
}
